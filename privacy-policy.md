...
Extension source code: [hqvdvn-cmd/FanslyExtension](https://github.com/hqvdvn-cmd/FanslyExtension)
...
For support or privacy questions, use the support email provided in the Chrome Web Store listing or open an issue in the [public source repository](https://github.com/hqvdvn-cmd/FanslyExtension/issues).
